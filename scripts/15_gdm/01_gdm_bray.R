...
# Compute dissimilarity matrix
asv_bray <- vegdist(asvtable, "bray")
...
sitepair_geography <- createSitePair(asv_bray, geography %>%
                                       dplyr::select(-latitude, -longitude), geodist = TRUE)
sitepair_morphometry <- createSitePair(asv_bray, morphometry, geodist = FALSE)
sitepair_landuse_soil <- createSitePair(asv_bray, landuse_soil, geodist = FALSE)
sitepair_climate <- createSitePair(asv_bray, climate, geodist = FALSE)
sitepair_waterchem <- createSitePair(asv_bray, waterchem, geodist = FALSE)
...
# plotGDM(sitepair_geography, geography, geodist = TRUE)
# plotGDM(sitepair_morphometry, morphometry, geodist = FALSE)
# plotGDM(sitepair_landuse_soil, landuse, geodist = FALSE)
# plotGDM(sitepair_climate, climate, geodist = FALSE)
# plotGDM(sitepair_waterchem, waterchem, geodist = FALSE)


#### Save site-pairs ####
# save(sitepair_geography, file = "output/gdm/sitepairs/lp2017-2019watercolumn18s_sitepair_protists_bray_geography.rda")
# save(sitepair_morphometry, file = "output/gdm/sitepairs/lp2017-2019watercolumn18s_sitepair_protists_bray_morphometry.rda")
# save(sitepair_landuse_soil, file = "output/gdm/sitepairs/lp2017-2019watercolumn18s_sitepair_protists_bray_landuse_soil.rda")
# save(sitepair_climate, file = "output/gdm/sitepairs/lp2017-2019watercolumn18s_sitepair_protists_bray_climate.rda")
# save(sitepair_waterchem, file = "output/gdm/sitepairs/lp2017-2019watercolumn18s_sitepair_protists_bray_waterchem.rda")
